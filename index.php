        ...
        <div class="list">
            <div class="item">
                ...
                <div class="content">
                    ...
                    <div class="des">
                        <!-- lorem 50 -->
                        Explora nuestra galería de fotos a continuación para conocer a algunos de nuestros amigos peludos que están buscando un hogar. Desde adorables cachorros y gatitos hasta compañeros más adultos, ¡hay un amigo para cada familia! Haz clic en "Ver más" para obtener más información sobre cada mascota.
                    </div>
                    <div class="buttons">
...
<main>
                ...
                <div class="col-lg-5">
                    ...
                    <form class="py-5" action="php/voluntarios_be.php" method="POST" autocomplete="off">
                            <div class="form-group">
                                <input type="text" pattern="[A-Za-zÑñÁáÉéÍíÓóÚú\s]+" title="Solo se pueden letras" class="form-control border-0 p-4" name="nombre" id="nombre" placeholder="Nombre Completo" required="required" />
                            </div>
                            <div class="form-group">
    ...
    <!-- Booking Start -->
        ...
        <div class="container__about div__offset">
            <div class="about">
                <div class="text__about">
                    ...
                    <p>Nos dedicamos apasionadamente a rescatar, cuidar y encontrar hogares amorosos para mascotas necesitadas. Somos más que un refugio; somos un puente hacia una nueva vida para nuestros amigos.</p>
                ...
                <section class="price container">
                    <h3 class="subtitle">Nuestras Mascotas</h3>
                        ...
                        <div class="contenido-card">
                                <h4>Joker</h4>
                                <p></p>
                                <a href="listamascotas/joker.php">Ver Màs</a>
                        </div>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="contenido-card">
                                <h4>Luke</h4>
                                <p></p>
                                <a href="listamascotas/luke.php">Ver Màs</a>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="contenido-card">
                                <h4>Hades</h4>
                                <p></p>
                                <a href="listamascotas/hades.php">Ver Màs</a>
                            </div>
                        </div>
                        </div>
                        ...
                        <div class="container-card">
                            <div class="card">
                                ...
                                <div class="contenido-card">
                                    <h4>Beny</h4>
                                    <p></p>
                                    <a href="listamascotas/beny.php">Ver Màs</a>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="contenido-card">
                                    <h4>Gatsby</h4>
                                    <p></p>
                                    <a href="listamascotas/gatsby.php">Ver Màs</a>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="contenido-card">
                                    <h4>Kiki</h4>
                                    <p></p>
                                    <a href="listamascotas/kiki.php">Ver Màs</a>
                                </div>
                            </div>
                    </div>
                    </div>
        ...
        <div class="containerContac">
                <h3 class="subtitle">Nuestras Ubicacion</h3>
        <div class="content">
            <div class="left-side">
            ...
            <div class="right-side">
                <div class="mapa">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3855.0849110836975!2d-88.24269412742139!3d14.932361985594264!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8f642bedd6f93943%3A0x853f39aa71a3e58c!2sAdoPet!5e0!3m2!1ses-419!2shn!4v1710470728683!5m2!1ses-419!2shn" width="900" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
        </div>
        </div>
...
<style>
    ...
    .my-icon-class {
        ...
        <a href="https://m.me/322806900924823" target="_blank">
