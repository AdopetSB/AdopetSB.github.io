...
<html lang="en">
    ...
    <body id="body-pd">
            ...
            <nav class="nav">
                <div>
                    ...
                    <div class="nav__list">
                        ...
                        <a href="index.php" class="nav__link active" title="Usuarios">
                ...
                <a href="../php/cerrar_sesion.php" class="nav__link" title="Cerrar Sesion">
        ...
        <ul class="breadcrumb">
            ...
            <li><a class="si" href="index.php">Usuarios</a></li>
        </ul>
...
<span class="hideText">
    ...
    <div class="users-form">
        ...
        <form action="insert_user.php" method="POST">
            ...
            <input type="text" name="id_cargo" placeholder="id_cargo, (1- perfil admin) y (0- usuario)">
