...
$sql = "SELECT * FROM perros WHERE id = 2";
...
<header>
    ...
    <?php while ($row = mysqli_fetch_array($query)): ?>
        <div class="container-img">
            ...
            <!-- <img src="../img/mascotasF/zero.jpg" alt="imagen-producto"/> -->
        </div>
    ...
    <section class="container-related-products">
        ...
        <div class="card-list-products">
            <div class="card">
                <div class="card-img">
                    <a href="../listamascotas/hades.php"><img src="../img/mascotasF/siberianobb.jpg" alt="producto-1" title="Ver más"/></a>
                </div>
                <div class="info-card">
                    <div class="text-product">
                        <!-- <a href="login.php"> <h3>Zero - Rottweiler</h3> </a> -->
                        <h3>Hades - Husky siberiano</h3>
                        <p class="category">Inquieto, Alegre</p>
                    </div>
            ...
            <div class="card">
                <div class="card-img">
                <a href="../listamascotas/newt.php"><img src="../img/mascotasF/newt.jpg" alt="producto-1" title="Ver más"/></a>
                </div>
                <div class="info-card">
                    <div class="text-product">
                        <h3>Newt - Show Show</h3>
                        <p class="category">Juguetón, Alegre</p>
                    </div>
            ...
            <div class="card">
                <div class="card-img">
                <a href="../listamascotas/luke.php"><img src="../img/mascotasF/luke.jpg" alt="producto-1" title="Ver más"/></a>
                </div>
                <div class="info-card">
                    <div class="text-product">
            ...
            <div class="card">
                <div class="card-img">
                <a href="../listamascotas/joker.php"><img src="../img/mascotasF/BulldogFrances.jpg" alt="producto-1" title="Ver más"/></a>
                </div>
                <div class="info-card">
                    <div class="text-product">
