<?php
include("../conejos/connection.php");
$con = connection();

$sql = "SELECT * FROM conejos WHERE id = 1";
...
<header>
    ...
    <div class="container-title">Conejos</div>
    ...
    <section class="container-related-products">
        ...
        <div class="card-list-products">
            <div class="card">
                <div class="card-img">
                    <a href="../listamascotas/luna.php"><img src="../img/mascotasF/Luna.jpg" alt="producto-1" title="Ver más"/></a>
                </div>
                <div class="info-card">
                    <div class="text-product">
                        <!-- <a href="login.php"> <h3>Zero - Rottweiler</h3> </a> -->
                        <h3>Luna - Periquito australiano</h3>
            ...
            <div class="card">
                <div class="card-img">
                <a href="../listamascotas/lu.php"><img src="../img/mascotasF/lu.jpg" alt="producto-1" title="Ver más"/></a>
                </div>
                <div class="info-card">
                    <div class="text-product">
                        <h3>Lu - Gato Persa</h3>
