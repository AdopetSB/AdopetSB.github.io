...
$sql = "SELECT * FROM perros WHERE id=26";
...
<header>
    ...
    <?php while ($row = mysqli_fetch_array($query)): ?>
        <div class="container-img">
            ...
            <!-- <img src="../img/mascotasF/Newt.jpg" alt="imagen-producto"/> -->
        </div>
        <div class="container-info-product">
            <div class="container-price">
                <span><th><?= $row['nombre'] ?></span>
        ...
        <div class="container-modal">
            ...
            <!-- informacion controlada por php y mysql -->
    ...
    <section class="container-related-products">
        ...
        <div class="card-list-products">
            <div class="card">
                <div class="card-img">
                    <a href="../listamascotas/zero.php"><img src="../img/mascotasF/Zero.jpg" alt="producto-1" title="Ver más"/></a>
                </div>
                <div class="info-card">
            ...
            <div class="card">
                <div class="card-img">
                <a href="../listamascotas/baloo.php"><img src="../img/mascotasF/Labrador.jpg" alt="producto-1" title="Ver más"/></a>
                </div>
                <div class="info-card">
                    <div class="text-product">
            ...
            <div class="card">
                <div class="card-img">
                <a href="../listamascotas/luke.php"><img src="../img/mascotasF/PastorAleman.jpg" alt="producto-1" title="Ver más"/></a>
                </div>
                <div class="info-card">
                    <div class="text-product">
