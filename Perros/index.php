...
$sql = "SELECT * FROM mascotas WHERE tipo_mascota = 'perro'";
...
<html lang="en">
    ...
    <body id="body-pd">
        ...
        <ul class="breadcrumb">
            ...
            <li><a class="si" href="index.php">Perros</a></li>
        </ul>
        <br>
    ...
    <span class="hideText">
        <body>
            <div class="users-form">
                <h1>Crear registro de Perro</h1>
                <form action="insert_user.php" method="POST" enctype="multipart/form-data">
                    <input type="file" name="imagen" accept="image/*"> 
                    <input type="text" name="nombre" placeholder="Nombre">
                    <input type="text" name="tipo_mascota" placeholder="Tipo Mascota (perro)">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Listado de Perros</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
