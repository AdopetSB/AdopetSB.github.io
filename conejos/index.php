...
$sql = "SELECT * FROM mascotas WHERE tipo_mascota = 'conejo'";
...
<html lang="en">
    ...
    <body id="body-pd">
        ...
        <ul class="breadcrumb">
            ...
            <li><a class="si" href="index.php">Conejos</a></li>
        </ul>
        <br>
        ...
        <span class="hideText">
            <div class="users-form">
                <h1>Crear registro de conejo</h1>
            <form action="insert_user.php" method="POST">
                <input type="file" name="imagen" placeholder="imagen"> 
                <input type="text" name="nombre" placeholder="Nombre">
                <input type="text" name="tipo_mascota" placeholder="Tipo Mascota (conejo)"> 
                <input type="text" name="raza" placeholder="Raza">
                <input type="text" name="edad" placeholder="Edad">
                <input type="text" name="sexo" placeholder="Sexo">
                <input type="text" name="temperamento" placeholder="Temperamento">
                <input type="text" name="espiritu" placeholder="Espíritu">
                <input type="text" name="salud" placeholder="Salud">
                <!-- <input type="text" name="vacunas" placeholder="Vacunas"> -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Listado de Conejos</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                            ...
                            <tbody>
                                ...
                                while ($dato = mysqli_fetch_array($query)): ?>
                                        <tr>
                                            ...
                                            <td><img src="../img/mascotasF/<?php echo $dato['imagen']; ?>" width="100px" ></td>
                                            <td><?php echo $dato["nombre"]; ?></td>
                                            <td><?php echo $dato["raza"]; ?></td>
                                            <td><?php echo $dato["edad"]; ?></td>
                                            <td><?php echo $dato["sexo"]; ?></td>
                                            <td>
                                                <a href="../mascota_admin.php?id=<?= $dato['id'] ?>" class="btn btn-success"><ion-icon name="eye-outline"></ion-icon></a>
