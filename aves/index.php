...
$sql = "SELECT * FROM mascotas WHERE tipo_mascota = 'ave'";
...
<html lang="en">
    ...
    <body id="body-pd">
        ...
        <ul class="breadcrumb">
            ...
            <li><a class="si" href="index.php">Aves</a></li>
        </ul>
        <br>
    ...
    <div class="users-form">
        <h1>Crear registro de aves</h1>
        <form action="insert_user.php" method="POST">
            <input type="file" name="imagen" placeholder="imagen">   
            <input type="text" name="nombre" placeholder="Nombre">
            <input type="text" name="tipo_mascota" placeholder="Tipo Mascota (ave)">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Listado de Aves</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
