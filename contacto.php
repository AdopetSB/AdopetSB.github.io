    ...
    <script src="https://kit.fontawesome.com/64d58efce2.js" crossorigin="anonymous"></script>
        ...
        <body>
            ...
            <div class="contact-form">
                ...
                <form action="php/contacto_be.php" method="POST" autocomplete="off"> 
                    <input type="hidden" name="_template" value="table">
                        <h3 class="title">Contactanos</h3>
            <div class="input-container">
                <input type="text" pattern="[A-Za-zÑñÁáÉéÍíÓóÚú\s]+" title="Solo se pueden letras" name="nombre" class="input" title="Escribe tu Nombre"/>
            ...
            <form method="post" action="iniciosesion/vacio.php">
