...
$sql = "SELECT * FROM mascotas WHERE tipo_mascota = 'gato'";
...
<html lang="en">
    ...
    <body id="body-pd">
        ...
        <ul class="breadcrumb">
            ...
            <li><a class="si" href="index.php">Gatos</a></li>
        </ul>
        <br>
        ...
        <h1>Crear registro de gato</h1>
        <br>
        <form action="insert_user.php" method="POST">
            <input type="file" name="imagen" placeholder="imagen">
            <input type="text" name="nombre" placeholder="Nombre">
            <input type="text" name="tipo_mascota" placeholder="Tipo Mascota (gato)">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Listado de Gatos</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
