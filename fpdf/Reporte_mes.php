...
function generateReport($month)
{
    ...
    // según el mes seleccionado. Este es un ejemplo de cómo se vería:

    require '../php/conexion.php';

    $mes = $_POST['month'];

    $sql = "SELECT * FROM adopciones WHERE DATE_FORMAT(fecha, '%Y-%m') = ?";
    ...
    while ($row = $resultado->fetch_assoc()) {
        ...
        $pdf->Cell(28, 10, $row['raza'], 1, 0, 'C', 0);
        $pdf->Cell(35, 10, $row['tipo_mascota'], 1, 0, 'C', 0);
