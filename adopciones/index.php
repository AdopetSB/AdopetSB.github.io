...
<html lang="en">
    <head>
        ...
        <ul class="breadcrumb">
            ...
            <li><a class="si" href="index.php">Adopciones</a></li>
        </ul>

        <br>

    <button class="read-more-btn" title="Agregar Usuarios"> <ion-icon name="person-add-outline" ></ion-icon> </button>
    <a href="../reporte_generado.php" class="pulse-effect" title="Generar Reportes">Reportes <i class="fa-solid fa-file-pdf"></i></a>
    ...
    <span class="hideText">
        ...
        <form action="insert_user.php" method="POST">
            ...
            <input type="text" name="raza" placeholder="Raza de la Mascota">
            <input type="text" name="tipo_mascota" placeholder="Tipo Mascota">
            <input type="text" name="nombre" placeholder="Nombre del Adoptante">
            <input type="email" name="correo" placeholder="Correo">
            <input type="tel" pattern="[0-9]{4}-[0-9]{4}" title="Ingrese un número de teléfono válido (8 dígitos separados por un guion)" name="telefono" placeholder="Telefono">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Tabla de Contactos</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
