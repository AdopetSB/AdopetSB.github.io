...
<header>
    ...
    <section class="container-related-products">
        ...
        <div class="card-list-products">
            <div class="card">
                <div class="card-img">
                    <a href="hades.php"><img src="../img/mascotasF/siberianobb.jpg" alt="producto-1" title="Ver más"/></a>
                </div>
                <div class="info-card">
            ...
            <div class="card">
                <div class="card-img">
                <a href="newt.php"><img src="../img/mascotasF/newt.jpg" alt="producto-1" title="Ver más"/></a>
                </div>
                <div class="info-card">
                    <div class="text-product">
            ...
            <div class="card">
                <div class="card-img">
                <a href="luke.php"><img src="../img/mascotasF/luke.jpg" alt="producto-1" title="Ver más"/></a>
                </div>
                <div class="info-card">
                    <div class="text-product">
