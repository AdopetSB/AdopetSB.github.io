...
//$sql = "SELECT * FROM perfilusuario WHERE id = '$id_perfil'";
                    ...
                    <ul class="navbar-nav ml-auto ml-md-0">
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                                ...
                                <a class="dropdown-item" href="../perfil/perfil.php?id1=<?php echo $row['id']; ?>&id_perfil=<?php echo $row['id']; ?>">Perfil</a>
    ...
    <main>
        ...
        <div class="container-info-product">
            ...
            <div class="container-add-cart">
                <button class="btn-add-to-cart"> <a href="../iniciosesion/mascotas.php"><i class="fa-solid fa-plus"></i> Ver más </a> </button> 
                ...
                <button class="btn-add-to-cart"><a href="../iniciosesion/formulario.php?id=<?php echo $row['id']; ?>"><i class="fa-solid fa-heart-circle-plus"></i> Adoptar </a> </button> 
            </div> 
