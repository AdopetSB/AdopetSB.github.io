...
<header>
    ...
    <section class="container-related-products">
        ...
        <div class="card-list-products">
            <div class="card">
                <div class="card-img">
                    <a href="../mascotas/zero.php"><img src="../img/mascotasF/Zero.jpg" alt="producto-1" title="Ver más"/></a>
                </div>
                <div class="info-card">
            ...
            <div class="card">
                <div class="card-img">
                <a href="../mascotas/newt.php"><img src="../img/mascotasF/newt.jpg" alt="producto-1" title="Ver más"/></a>
                </div>
                <div class="info-card">
                    <div class="text-product">
            ...
            <div class="card">
                <div class="card-img">
                <a href="../mascotas/luke.php"><img src="../img/mascotasF/PastorAleman.jpg" alt="producto-1" title="Ver más"/></a>
                </div>
                <div class="info-card">
                    <div class="text-product">
            ...
            <div class="card">
                <div class="card-img">
                <a href="../mascotas/joker.php"><img src="../img/mascotasF/BulldogFrances.jpg" alt="producto-1" title="Ver más"/></a>
                </div>
                <div class="info-card">
                    <div class="text-product">
