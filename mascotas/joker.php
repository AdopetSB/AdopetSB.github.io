...
<header>
    ...
    <section class="container-related-products">
        ...
        <div class="card-list-products">
            ...
            <div class="card">
                <div class="card-img">
                <a href="../mascotas/baloo.php"><img src="../img/mascotasF/Labrador.jpg" alt="producto-1" title="Ver más"/></a>
                </div>
                <div class="info-card">
                    <div class="text-product">
            ...
            <div class="card">
                <div class="card-img">
                <a href="../mascotas/luke.php"><img src="../img/mascotasF/luke.jpg" alt="producto-1" title="Ver más"/></a>
                </div>
                <div class="info-card">
                    <div class="text-product">
            ...
            <div class="card">
                <div class="card-img">
                <a href="../mascotas/hades.php"><img src="../img/mascotasF/siberianobb.jpg" alt="producto-1" title="Ver más"/></a>
                </div>
                <div class="info-card">
                    <div class="text-product">
