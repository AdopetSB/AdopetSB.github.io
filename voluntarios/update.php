...
<body id="body-pd">
        ...
        <nav class="nav">
            <div>
                ...
                <div class="nav__list">
                    ...
                    <a href="../voluntarios/index.php" class="nav__link active" title="Voluntarios">
    ...
    <body>
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="index.php">Voluntarios</a></li>
        ...
        <div class="users-form">
            ...
            <form action="edit_user.php" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="experiencia" name="experiencia" placeholder="experiencia"
                        value="<?= $row['experiencia'] ?>">
                </div>

                <div class="form-group">
                    <label for="puesto">Puesto</label>
                    <input type="text" id="puesto" name="puesto" placeholder="puesto" value="<?= $row['puesto'] ?>">
                </div>
